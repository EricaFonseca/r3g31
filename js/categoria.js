let url ="http://140.238.152.216:8083/api/Category/all";
...
function editar(id) {
  ...
  url ="http://140.238.152.216:8083/api/Category";
...
function guardarNuevo() {
  ...
  url = "http://140.238.152.216:8083/api/Category/save";         
...
function guardarEditar() {
  ...
  //convierto el objeto de javascript a formato json
  let objetoJson = JSON.stringify(objeto)
  url ="http://140.238.152.216:8083/api/Category/update";
...
function guardarBorrar() {
  ...
  */
  ...
  let url = "http://140.238.152.216:8083/api/Category/delete";
...
function traerdatos() {
  ...
  url="http://140.238.152.216:8083/api/Category/all"
  /*2 propiedad onreadystatechange asigna a una funcion
        que funcion valida si la respuesta fue exitosa
        readyState=4 y status=200, en cuyo caso obtiene la respuesta, 
        le aplica formato y modifica la pagina o vista
