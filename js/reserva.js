...
let url = "http://140.238.152.216:8083/api/Reservation/all"
...
function editar(id) {
  ...
  let url =
    "https://g204ecfa60e021a-g3qlhq6a8n5r6dq0.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/game/game";
...
function guardarNuevo() {
  ...
  let url ="http://140.238.152.216:8083/api/Reservation/save"
...
function guardarEditar() {
  ...
  //recuperar la informacion ingresada en el formulario
  let idGame = document.getElementById("idModif").value
  let addressGame = document.getElementById("addressModif").value
  let exensionGame = document.getElementById("exensionModif").value
  let categoryIdGame = document.getElementById("categoryIdModif").value
  let nameGame = document.getElementById("nameModif").value

  //creo un objeto javascript
  let objeto = {
    id: idGame,
    address: addressGame,
    exension: exensionGame,
    category_id: categoryIdGame,
    name: nameGame
  }
...
function guardarBorrar() {
  //recuperar la informacion ingresada en el formulario
  let idGame = document.getElementById("idDelete").value
...
function traerdatos() {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://140.238.152.216:8083/api/Reservation/all"
...
function traejuegos(){
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://140.238.152.216:8083/api/Farm/all";
  let id;
  let nombre;
  let respuesta;
  /*2 propiedad onreadystatechange asigna a una funcion
...
function traeclientes(){
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://140.238.152.216:8083/api/Client/all"
  let id;
  let nombre;
  let respuesta;
  /*2 propiedad onreadystatechange asigna a una funcion
