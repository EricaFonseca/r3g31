...
let url="http://140.238.152.216:8083/api/Message/all"
...
function editar(id) {
    ...
    url = "http://140.238.152.216:8083/api/Message"
...
function eliminar(id) {
    let url = "http://140.238.152.216:8083/api/Message"
...
function guardarNuevo() {
    ...
    url = "http://140.238.152.216:8083/api/Message/save";
...
function guardarBorrar() {
    let url = "http://140.238.152.216:8083/api/Message/delete"
...
function traerdatos() {
    let registros = ""
    let id = ""
    url="http://140.238.152.216:8083/api/Message/all"
...
function traefincas(){
    //1 crear un objeto XMLHttpRequest
    let peticion = new XMLHttpRequest();
    url = "http://140.238.152.216:8083/api/Game/all";
    let id;
    let nombre;
    let respuesta;
    /*2 propiedad onreadystatechange asigna a una funcion
